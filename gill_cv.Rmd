...
- <i class="fa fa-laptop"></i> **Programming**: R, Bioconductor, Python, Unix, GitHub, HTML
...
Amy Gill {#title}
--------------------------------------------------------------------------------
My career goals are to advance personalized cancer therapy with data-driven systems biology and improve quantitative biology education resources. I currently seek a doctoral program to enhance my bioinformatics skills and perform patient-centered research.
